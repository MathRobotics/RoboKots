...
def test_link_rel_frame():
    ...
    # Test with non-zero joint_coord  
    joint_coord = np.random.rand(1)
    expected_frame = joint.origin @ SE3.set_mat(SE3.exp(joint.joint_select_mat @ joint_coord))
...
def test_kinematics():
    ...
    expected_frame = p_link_frame @ (joint.origin @ SE3.set_mat(SE3.exp(joint.joint_select_mat @ joint_coord)))
...
def test_vel_kinematics():
    ...
    rel_frame = (joint.origin @ SE3.set_mat(SE3.exp(joint.joint_select_mat @ joint_coord)))
    rel_vel = joint.origin.mat_inv_adj() @ (joint.joint_select_mat @ joint_veloc)
...
def test_acc_kinematics():
    ...
    rel_frame = joint.origin @ SE3.set_mat(SE3.exp(joint.joint_select_mat @ joint_coord))
    rel_vel = joint.origin.mat_inv_adj() @ (joint.joint_select_mat @ joint_veloc)
    rel_acc = joint.origin.mat_inv_adj() @ (joint.joint_select_mat @ joint_accel)
...
def test_kinematics_cmtm():
    ...
    rel_frame = joint.origin @ SE3.set_mat(SE3.exp(joint.joint_select_mat @ joint_coord))
    rel_veloc = joint.origin.mat_inv_adj() @ (joint.joint_select_mat @ joint_veloc)
    rel_accel = joint.origin.mat_inv_adj() @ (joint.joint_select_mat @ joint_accel)
