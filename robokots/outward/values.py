...
def update_outward_state(robot : RobotStruct, motions : VariablePack, state_cache : StateCache, is_dynamics : bool, order = 3) -> dict:
  ...
  print("VariablePack revision:", motions.revision)
